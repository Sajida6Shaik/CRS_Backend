...
//
	...
	List<CarDetails> getBySourceLocationAndDestinationLocation(@Param("sourceLocation") String sourceLocation,
			@Param("destinationLocation") String destinationLocation, @Param("fromDate") LocalDate fromDate,
