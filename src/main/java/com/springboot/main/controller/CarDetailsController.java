...
//	@PreAuthorize("hasAuthority('ADMIN') OR hasAuthority('HOST')")
	...
	public List<CarDetails> getCarDetailsByLocationAndDate(@RequestParam(name="fd") String fromDate, @RequestParam(name="td") String toDate,
			@RequestParam(name="sl") String sourceLocation, @RequestParam(name="dl") String destinationLocation) {
//	System.out.println(body.toString());	  
		...
		System.out.println(fromDate + " " + toDate + " " + sourceLocation + " " + destinationLocation + " " + fromDateParsed + " " + toDateParsed);

		List<CarDetails> carDetails = carDetailsService.getCarDetailsByLocationAndDate(sourceLocation,
				destinationLocation, fromDateParsed, toDateParsed);
